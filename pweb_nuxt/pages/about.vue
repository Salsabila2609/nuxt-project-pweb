...
<div class="content" data-aos="fade-left" data-aos-delay="600">
    ...
    <p>Welcome to our travel blog, where we bring the world to your fingertips. From the vibrant streets of bustling cities to the tranquil landscapes off the beaten path, our blog is a celebration of diversity and the beauty that exists in every corner of the globe. Whether you're a seasoned globetrotter or a first-time explorer, our goal is to inspire, inform, and elevate your travel experiences.</p>
...
<div class="video-container" data-aos="fade-right" data-aos-delay="300">
    ...
    <div class="box" data-aos="zoom-in-up" data-aos-delay="750">
        ...
        <p>Enjoy the best travel experiences without breaking the bank. Our affordable prices ensure that your adventures are budget-friendly.</p>
    </div>

    <div class="box" data-aos="zoom-in-up" data-aos-delay="900">
        <i class="fas fa-headset"></i>
        <h3>24/7 Support</h3>
        <p>Our dedicated support team is available around the clock to assist you. Your comfort and safety are our top priorities.</p>
    </div>
...
export default {
  ...
  methods: {
    ...
    const postResponse = await $fetch("http://localhost:3000/api/submitForm", {
      method: "POST",
